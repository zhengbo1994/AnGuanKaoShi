    ...
    public class ExcelAdoDotNetHelper : IDisposable
    {
        ...
        public int ExecuteNonQuery(string sql, Dictionary<string, object> para = null)
        {
            ...
            if (para != null)
            {
                ...
                {
                    _cmd.Parameters.AddWithValue(kv.Key, kv.Value);
                }
            }
            return _cmd.ExecuteNonQuery();
        }
        public DataTable ExecuteDataTale(string sql, Dictionary<string, object> para = null)
        {
            ...
            myDataAdapter.SelectCommand = _cmd;
