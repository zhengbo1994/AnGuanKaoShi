    ...
    public class CertificateDelayApplyController : BaseController
    {
        ...
        public JsonResult GetCertificateListForJqgrid(GetEmployeeListForJqgridParam param)
        {
            try
            {
                ...
                List<Biz_Certificate> certificateList = certificateDelayWorkFlowCtrl.GetCertificateListForDelayApply(param.employeeName, param.iDNumber, param.certificateNo, param.trainingInstitutionName, param.workFlowStatus, param.page, param.rows, ref totalCount);
                ...
                List<Biz_XX_CertificateDelayApplyRecord> certificateDelayApplyRecordList = certificateDelayWorkFlowCtrl.GetCertificateDelayApplyRecordListByCertificateIdList(certificateIdList);
        ...
        public JsonResult GetTrainingInstitutionList()
        {
            ...
            List<GetTrainingInstitutionListResult> trainingInstitutionList = trainingInstitutionCtrl.GetAccreditTrainingInstitutionList().Select(p => new GetTrainingInstitutionListResult()
            {
